            ...
            <div className='aboutMe-wrapper container'>
                ...
                <div className='aboutMe-main-content-wrapper'>
                    ...
                    <div className='aboutMe-stacklist-wrapper'>
                        <p><span>STACK</span> Adept with technologies such as; JavaScript, React, NextJS, CSS, SCSS, CSS-in-JS, NodeJS, ExpressJS, MongoDB, PostgreSQL...<br/><a href='https://github.com/ImieboGodson' target='_blank' rel='noreferrer' className='aboutMe-links'>SEE MY GITHUB</a></p>
