      ...
      <div className="aboutMe-wrapper container">
        ...
        <div className="aboutMe-main-content-wrapper">
          <div className="aboutMe-text-main-wrapper">
            <p className="aboutMe-text-main">
              Passionate guy, a <span>visually-oriented</span> engineer adept at
              delivering <span>amazing user experiences</span>.
            </p>
          </div>
          <div className="aboutMe-stacklist-wrapper">
            <p>
              <span>STACK</span> Adept with technologies such as; JavaScript,
              React, Redux, NextJS, CSS, SCSS, CSS-in-JS, NodeJS, ExpressJS,
              MongoDB, PostgreSQL...
              <br />
              <a
          ...
          <div className="aboutMe-hobbies-wrapper">
            <p>
              <span>HOBBIES</span> How I spend my time; visiting new places,
              hanging out with friends, listening to podcasts and reading about
              the state of tech in Africa, writing about random stuff, playing
              Video games, figuring out life...
              <br />
              <a
          ...
          <div className="aboutMe-quote-wrapper">
            <p>
              ...
              <br /> "The function of man is to live, not to exist.
              <br /> I shall not waste my days trying to prolong them. I shall
              use my time."
            </p>
            {/* <a href='https://github.com/ImieboGodson' target='_blank' rel='noreferrer' className='aboutMe-links'>Checkout My Github</a> */}
          </div>
