          ...
          <div className='hero-wrapper container'>
            <div className='hero-left'>
              ...
              <div className='btnWrapper'>
                <a href='https://drive.google.com/uc?export=download&id=1Ogh1xdK_Ic4uq07TZZbizcE3pXM6JLDX' className='btn'><IoDocumentText className='btn-icon'/> <p>Download Resume</p></a>
              </div>
