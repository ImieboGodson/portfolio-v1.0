          ...
          <div className='hero-wrapper container'>
            <div className='hero-left'>
              ...
              <div className='btnWrapper'>
                <a href='https://drive.google.com/uc?export=download&id=1ZDgsBalaoK2sPlY1_uLQyhD6l5yh7oRM' className='btn'><IoDocumentText className='btn-icon'/> <p>Download Resume</p></a>
              </div>
