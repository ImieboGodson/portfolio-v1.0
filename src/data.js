export const ProjectsArray = [
    {
        ...
        discription: "This project is a take home test for a frontend role at Lendsqr. The goal was to build a portion of the Lendsqr dashboard where we can view the a table of users and and check each user details.",
        status: 'Completed',
